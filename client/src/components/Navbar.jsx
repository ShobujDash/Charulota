...
function Navbar({ darkMode, toggleDarkMode, toggleSidebar }) {
  return (
    <div className="fixed top-0 z-50 w-full bg-dark_dark border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start rtl:justify-end">
            ...
            <a href="#" className="flex ms-2 md:me-24">
              <img src={assets.logo} className="w-10 rounded-full mr-3" alt="" />
